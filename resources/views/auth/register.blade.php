<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- data_birth -->
        <div class="mt-4">
            <x-text-input id="data_birth" class="block mt-1 w-full" type="date" name="data_birth" :value="old('data_birth')"
                required autofocus autocomplete="data_birth" placeholder="дата рождения" maxlength="20" />
